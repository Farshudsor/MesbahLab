...
if runC6:
    ...
    for k in range(run_time):
        ...
        #Build and solve the dual optimization problem
        Jd, qu, op, dev_l, dev_u,Fx = Dual.robust_dual(n_st,n_ip,n_op,n_par,n_pred,Sigmak,mdl_ode,fy,xk3,uk3,slack,thetah3,Tsamp,Q,Qz,R,uk_ce_3,xkh0,theta_par,xk_ce_3,xk_lb,xk_ub)
