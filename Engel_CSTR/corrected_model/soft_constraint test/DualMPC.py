...
Qz = np.diag([0, 0, 0, 0,  0,  0,  0, ((3.0457*10**(-7))*discritize*.4)**2, (323.05*.4)**2 ])
...
if runC3:
    ...
    for k in range(run_time):
        ...
        Jd, qu, op = Dual.robust_dual(n_st,n_ip,n_op,n_par,n_pred,Sigmak,mdl_ode,fy,xk3,uk3,thetah3,Tsamp,Q,Qz,R,uk_ce_3,xkh0,theta_par,xk_ce_3,xk_lb,xk_ub)
