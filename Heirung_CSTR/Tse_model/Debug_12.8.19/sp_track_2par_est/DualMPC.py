...
if runC3:
    ...
    for k in range(run_time):
        ...
        Jd, qu, op = Dual.gencost(n_st,n_ip,n_op,n_par,n_pred,Sigmak,mdl_ode,fy,xk3,uk3,thetah3,Tsamp,xk_sp,Wx,Wu,Q,Qz,R,uk_ce_3,xkp.T,C_ode,theta_par,xk_ce_3)
        ...
        res = solver( x0=uk_opt, p=zkh0, ubx=uk_ub, lbx=uk_lb, lbg=0, ubg=0)
...
Dual_cost = sum(sum((res3_xk-Wx)**2))
Ce_cost =  sum(sum((res2_xk-Wx)**2))
...
print 'duel S.P. miss squared = ', Dual_cost
print '             est. error sq = ', (theta_act_u - res3_theta[-1,:])**2
print ''
print 'ce  S.P. miss squared= ', Ce_cost
