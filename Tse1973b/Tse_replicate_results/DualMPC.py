...
if runC3:
    ...
    Jx = Function('Jx',[xk3,uk3],[jacobian((xk3+c1_mdl),xk3)])
    Jz = Function('Jz',[xk3,uk3,thetah3],[jacobian((vertcat(xk3,thetah3)+mdl_ode),vertcat(xk3,thetah3))])
    Ju = Function('Ju',[xk3,uk3,thetah3],[jacobian((vertcat(xk3,thetah3)+mdl_ode),uk3)])
    ...
    for k in range(run_time):
        ...
        Jd, qu, op = Dual.gencost(n_st,n_ip,n_op,n_par,n_pred,Sigmak,mdl_ode,fy,xk3,uk3,thetah3,Tsamp,xk_sp,Wx,Wu,Q,Qz,R,uk_ce,xkp.T,C_ode,theta_par,xk_ce)
...
if runC2:
    ...
    #Jacobians for predictions
    Jx = Function('Jx',[xk2,uk2],[jacobian((xk2+c1_mdl),xk2)])
    Jz = Function('Jz',[xk2,uk2,thetah2],[jacobian((vertcat(xk2,thetah2)+mdl_ode),vertcat(xk2,thetah2))])
    Ju = Function('Ju',[xk2,uk2,thetah2],[jacobian((vertcat(xk2,thetah2)+mdl_ode),uk2)])
