...
All_data =[]
res2_xk = np.zeros((n_sim*n_st,run_time) )
res3_xk = np.zeros((n_sim*n_st,run_time) )
res2_uk = np.zeros((n_sim*n_ip,run_time-1) )
res3_uk = np.zeros((n_sim*n_ip,run_time-1) )
res2_theta = np.zeros((n_sim*n_par,run_time) )
res3_theta = np.zeros((n_sim*n_par,run_time) )
...
def Mkplots(n_sim, xk, uk, theta, case2):
