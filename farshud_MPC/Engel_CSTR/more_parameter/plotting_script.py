...
if 0:
    row_per = (1+n_st*5 + 1+n_ip*5 + 1+n_par*5)
    ...
    for i in np.arange(0, n_sim):
        ...
        res_xk[i*n_st+1,:] = All_data[i*row_per+6][2].replace('[','').replace(']','').replace('\n','').split()
        res2_xk[i*n_st+1,:] = All_data[i*row_per+7][2].replace('[','').replace(']','').replace('\n','').split()
        res4_xk[i*n_st+1,:] = All_data[i*row_per+8][2].replace('[','').replace(']','').replace('\n','').split()
        res3_xk[i*n_st+1,:] = All_data[i*row_per+9][2].replace('[','').replace(']','').replace('\n','').split()
        res5_xk[i*n_st+1,:] = All_data[i*row_per+10][2].replace('[','').replace(']','').replace('\n','').split()

        res_xk[i*n_st+2,:] = All_data[i*row_per+11][2].replace('[','').replace(']','').replace('\n','').split()
        res2_xk[i*n_st+2,:] = All_data[i*row_per+12][2].replace('[','').replace(']','').replace('\n','').split()
        res4_xk[i*n_st+2,:] = All_data[i*row_per+13][2].replace('[','').replace(']','').replace('\n','').split()
        res3_xk[i*n_st+2,:] = All_data[i*row_per+14][2].replace('[','').replace(']','').replace('\n','').split()
        res5_xk[i*n_st+2,:] = All_data[i*row_per+15][2].replace('[','').replace(']','').replace('\n','').split()

        res_xk[i*n_st+3,:] = All_data[i*row_per+16][2].replace('[','').replace(']','').replace('\n','').split()
        res2_xk[i*n_st+3,:] = All_data[i*row_per+17][2].replace('[','').replace(']','').replace('\n','').split()
        res4_xk[i*n_st+3,:] = All_data[i*row_per+18][2].replace('[','').replace(']','').replace('\n','').split()
        res3_xk[i*n_st+3,:] = All_data[i*row_per+19][2].replace('[','').replace(']','').replace('\n','').split()
        res5_xk[i*n_st+3,:] = All_data[i*row_per+20][2].replace('[','').replace(']','').replace('\n','').split()

        res_xk[i*n_st+4,:] = All_data[i*row_per+21][2].replace('[','').replace(']','').replace('\n','').split()
        res2_xk[i*n_st+4,:] = All_data[i*row_per+22][2].replace('[','').replace(']','').replace('\n','').split()
        res4_xk[i*n_st+4,:] = All_data[i*row_per+23][2].replace('[','').replace(']','').replace('\n','').split()
        res3_xk[i*n_st+4,:] = All_data[i*row_per+24][2].replace('[','').replace(']','').replace('\n','').split()
        res5_xk[i*n_st+4,:] = All_data[i*row_per+25][2].replace('[','').replace(']','').replace('\n','').split()

        res_xk[i*n_st+5,:] = All_data[i*row_per+26][2].replace('[','').replace(']','').replace('\n','').split()
        res2_xk[i*n_st+5,:] = All_data[i*row_per+27][2].replace('[','').replace(']','').replace('\n','').split()
        res4_xk[i*n_st+5,:] = All_data[i*row_per+28][2].replace('[','').replace(']','').replace('\n','').split()
        res3_xk[i*n_st+5,:] = All_data[i*row_per+29][2].replace('[','').replace(']','').replace('\n','').split()
        res5_xk[i*n_st+5,:] = All_data[i*row_per+30][2].replace('[','').replace(']','').replace('\n','').split()

        res_xk[i*n_st+6,:] = All_data[i*row_per+31][2].replace('[','').replace(']','').replace('\n','').split()
        res2_xk[i*n_st+6,:] = All_data[i*row_per+32][2].replace('[','').replace(']','').replace('\n','').split()
        res4_xk[i*n_st+6,:] = All_data[i*row_per+33][2].replace('[','').replace(']','').replace('\n','').split()
        res3_xk[i*n_st+6,:] = All_data[i*row_per+34][2].replace('[','').replace(']','').replace('\n','').split()
        res5_xk[i*n_st+6,:] = All_data[i*row_per+35][2].replace('[','').replace(']','').replace('\n','').split()

        ## Parameters
        ##############
        res_theta[i*n_par,:] = All_data[i*row_per+37][2].replace('[','').replace(']','').replace('\n','').split()
        res2_theta[i*n_par,:] = All_data[i*row_per+38][2].replace('[','').replace(']','').replace('\n','').split()
        res4_theta[i*n_par,:] = All_data[i*row_per+39][2].replace('[','').replace(']','').replace('\n','').split()
        res3_theta[i*n_par,:] = All_data[i*row_per+40][2].replace('[','').replace(']','').replace('\n','').split()
        res5_theta[i*n_par,:] = All_data[i*row_per+41][2].replace('[','').replace(']','').replace('\n','').split()

        res_theta[i*n_par+1,:] = All_data[i*row_per+42][2].replace('[','').replace(']','').replace('\n','').split()
        res2_theta[i*n_par+1,:] = All_data[i*row_per+43][2].replace('[','').replace(']','').replace('\n','').split()
        res4_theta[i*n_par+1,:] = All_data[i*row_per+44][2].replace('[','').replace(']','').replace('\n','').split()
        res3_theta[i*n_par+1,:] = All_data[i*row_per+45][2].replace('[','').replace(']','').replace('\n','').split()
        res5_theta[i*n_par+1,:] = All_data[i*row_per+46][2].replace('[','').replace(']','').replace('\n','').split()

        ## Inputs
        ##############
        res_uk[i*n_par,:] = All_data[i*row_per+48][2].replace('[','').replace(']','').replace('\n','').split()
        res2_uk[i*n_par,:] = All_data[i*row_per+49][2].replace('[','').replace(']','').replace('\n','').split()
        res4_uk[i*n_par,:] = All_data[i*row_per+50][2].replace('[','').replace(']','').replace('\n','').split()
        res3_uk[i*n_par,:] = All_data[i*row_per+51][2].replace('[','').replace(']','').replace('\n','').split()
        res5_uk[i*n_par,:] = All_data[i*row_per+52][2].replace('[','').replace(']','').replace('\n','').split()

        res_uk[i*n_par+1,:] = All_data[i*row_per+53][2].replace('[','').replace(']','').replace('\n','').split()
        res2_uk[i*n_par+1,:] = All_data[i*row_per+54][2].replace('[','').replace(']','').replace('\n','').split()
        res4_uk[i*n_par+1,:] = All_data[i*row_per+55][2].replace('[','').replace(']','').replace('\n','').split()
        res3_uk[i*n_par+1,:] = All_data[i*row_per+56][2].replace('[','').replace(']','').replace('\n','').split()
        res5_uk[i*n_par+1,:] = All_data[i*row_per+57][2].replace('[','').replace(']','').replace('\n','').split()
if 1:
...
Mkplots(n_sim, res2_xk, res2_uk, res2_theta, case2, res_xk, res_uk,res_theta)
Mkplots(n_sim, res3_xk, res3_uk, res3_theta, case3, res_xk, res_uk,res_theta)
