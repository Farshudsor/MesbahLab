...
run_time = 100
Disturbance = 30 # time when k0 begins to be reduced
end_Disturbance = 50 # k0 has been reduced by 10%
end2_Disturbance = 70
...
for i in range(run_time):
    ...
    if i > end_Disturbance and i <= end2_Disturbance :
        theta_act[0] = theta_act[0] + slope_Disturbance  
...
if runC3:
    ...
    for k in range(run_time-1):
        ...
        if time[k] >= Disturbance and time[k] <= end_Disturbance :
            ...
            print('******        k2 is reduced           ****')
            print('******************************************')
        if time[k] > end_Disturbance and time[k] <= end2_Disturbance :
            theta_act[0] = theta_act[0] + slope_Disturbance
            print('******************************************')
            print('******        k0 is returning           ****')
            print('******************************************')
