...
def ce_mpc(F_ode,n_pred,n_ctrl,n_st,n_par_st,n_par_ip,n_ip,uk_lb,uk_ub,xk_lb,xk_ub,xk,theta_par,uk,Tsamp,xkh0,xk_sp,Wx,Wu,uk_opt):
    ...
    #    pdb.set_trace()
        ...
        #Cost function (5.8) - Soft Landing-Type example
        Jce = (mtimes(transpose(xk_end-Wx),(xk_end-Wx))) + Jce
...
## Case3 Function
##################
def gencost(n_st,n_ip,n_op,n_par,n_pred,Sigmak,mdl_ode,fy,xk,uk,thetah,Tsamp,xk_sp,Wx,Wu,Q,Qz,R,uk_ce,xkh0,C_ode,theta_par, xk_ce):
    ...
    for j in range(n_pred):
        if j==0:
            ...
            x_end = Fx(res_xkh_nom[j,:],uk_pred_nom[j,:],theta_par)
